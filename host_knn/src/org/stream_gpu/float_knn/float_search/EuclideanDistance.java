...
public class EuclideanDistance
   ...
   * processing. Please consider passing Float.POSITIVE_INFINITY as the cutOffValue to
   ...
   * distance(distance(Instance first, Instance second, float cutOffValue). It
   * is necessary to do so to get the correct distances if
   * distance(distance(Instance first, Instance second, float cutOffValue) is
