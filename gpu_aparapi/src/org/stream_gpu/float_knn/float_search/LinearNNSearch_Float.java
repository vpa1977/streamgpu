...
package org.stream_gpu.float_knn.float_search;
 ...
 */
public class LinearNNSearch_Float
  ...
  protected EuclideanDistance m_float_distance = new EuclideanDistance();
   ...
   */
  public LinearNNSearch_Float(Instances insts) {
    super(insts);
    m_float_distance.setInstances(insts);
  }
  ...
  public Instances kNearestNeighbours(Instance target, int kNN) throws Exception {
    ...
    for(int i=0; i<m_Instances.numInstances(); i++) {
      ...
      if(firstkNN<kNN) {
        ...
        distance = m_float_distance.distance(target, m_Instances.instance(i), Float.POSITIVE_INFINITY, m_Stats);
        ...
        distance = m_float_distance.distance(target, m_Instances.instance(i), (float)temp.distance, m_Stats);
